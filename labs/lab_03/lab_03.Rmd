...
A3: The five businesses are named AAAAA BBBB CCCCCC DDDDDD EEEEEE. 

DM Motors

```{r}
wv_ppp_loans %>% 
  filter(congressional_district == "WV-03") %>% 
  filter(name %in% c("DM Motors", "Dutch Miller Chevrolet", "Dutch Miller of Charleston", "Dutch Miller of Charlotte", "Dutch Miller Subaru"))
