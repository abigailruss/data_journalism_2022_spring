...
Note: To answer this question, you'll need to see every variation of the "city" column in Kanawha County, and then fully clean the city field for those cities. Hint: once cleaned, the dataframe that counts the number of loans by city should have 38 distinct cities for Kanawha County.  get down to 38
...
A3: The five businesses are named DM Motors, Dutch Miller Chevrolet, Dutch Miller of Charleston, Dutch Miller of Charlotte and Dutch Miller Subaru. They are owned by representative Carol Miller's husband Dutch Miller and they are car dealerships. In total the businesses received XYZZZ in loans. $$$$$$$$$ has been forgiven. Carol Miller originally voted for 



```{r}
wv_ppp_loans %>% 
 filter(name %in% c("DM MOTOR, INC","DUTCH MILLER CHEVROLET, INC.","DUTCH MILLER SUBARU, INC","DUTCH MILLER OF CHARLOTTE, INC","DUTCH MILLER OF CHARLESTON, INC")) %>% select(name,amount,business_type,congressional_district)
