...
**A6** There were three regions and 15 cities/counties in Maryland with positive net migrations for July 2017, July 2018 and July 2019. Combined that leaves 18 regions and jurisdictions. 
#is he asking for 2 or 3 here??????
```{r}
domestic_migration %>% 
  mutate(sums = `7/1/2016-7/1/2017` + `7/1/2017-7/1/2018`+ `7/1/2018-7/1/2019`) %>% 
  arrange(desc(sums)) %>% 
  select(`State/Jurisdiction`, sums)
