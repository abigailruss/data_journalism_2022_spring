...
berkeley_naics <- clean_berkeley %>% left_join(naics_codes, by="naics_code")
...
Guidance: there are a lot of steps you'll need to take to answer this question. You may find it helpful to write out in English what you plan to do step-by-step before you start writing code. Full service restaurants had the most loans with 74. 

**A3.** Martinsburg	is the city in Berkeley with the highest number of loans. 1166	
