...
**A1** The data as 33,336 rows and 58 columns.
...
**A2** Kanawha County has the most loans at 4273.
...
**A3** Palm Beach County got the fewest loans with only 2. 
...
**A4** There are only two loans to Palm Beach County because Palm Beach is not in West Virginia, it's in Florida. Kanawha County is one of the largest counties in WV so it makes sense that they will have more loans. 
...
**A5** The Greenbriar Hotel Corporation got the largest PPP loan for $8,912,202. The business is a Hotel and the loan retained 500 jobs. 
...
**A6** Gov. Jim Justice owns the Greenbriar. 
...
**A7** I think that it's newsworthy West Virginia gave PPP loans to places that list counties outside of the state of West Virginia, for example, Palm Beach. Some businesses only requested a few hundred dollars in certain counties while in Palm Beach, the minimum amount was 625,600.00. Fayette County had 590 loans compared with Doddridge's 43 loans but the average loan in Doddridge was 138,679.93 while it was only 77,581.86 in Fayette County. 
```{r}
