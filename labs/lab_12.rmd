...
**A1.** "The number of Traffic Stop 1054 incidents in the last 30 days, since March 20"
...
sub <- paste("The number of" format(latest_date$title, format="%B %d")) "incidents in the last 30 days, since", format(latest_date$date- 30, format="%B %d"))
sub

total_last_month <- crime_log%>% 
  filter(title >= latest_date$date- 30)
```
