...
```{r}
vaccinated_status <-read.csv("https://raw.githubusercontent.com/state-of-maryland/VaccineCSVs/master/Vax_ZIP_CODE_FirstSecondSingle_Totals_Raw.csv")
...
now()
vax <- vax %>% mutate(ZIP_CODE = str_pad(ZIP_CODE,5,pad = "0")) %>% inner_join(zip,c("ZIP_CODE"="code"))
