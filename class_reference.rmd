...
floor_date rounds all of the dates down to the first day of the month and so it gives you a number for how many times something happened in a month
    ...
    (ceiling dates round it up to the next month which is bad because it changes the means of months-- its importnat to use if you want to see what came in before a deadline that was the first of the month)
```{r}
maryland_ppp %>%
...
Filter then clean then group by then summarize 
