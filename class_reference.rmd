...
nrow(and_prince_georges)  <------ this is asking for how many rows there will be in what you are asking for 
```
...
nrow(or_prince_georges)   <------ this is asking for how many rows there will be in what you are asking for 
```