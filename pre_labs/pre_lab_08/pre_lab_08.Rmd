...
```{r echo=FALSE}
census_api_key("239bcc197c7e1f46f496dca8678a8e4be2eb5659", install=TRUE)
```
...
**Answer** Nevada is the state with the largest population growth. 
...
**Answer** Howard County Maryland had the highest median household income with an estimated 121160 with a margin of error of 2169. 
...
**Answer** No because they are overlapping. 

Is the difference between Howard and everyone else significant?
**Answer** Yes because even the lower end of the margin of error is much greater than the upper bound for other counties' margins of errors. 
...
**Answer** Somerset County and Caroline County each saw their median incomes fall from 2010-2019. Its possible that with the MOE the Caroline County decrease that is told by the -.27 is not actually negative. I would say it's more likely that the Somerset County decrease is correct because not only did the estimates decrease but the minimums from 2019 and 2010 are much lower than even the estimate. It may not be -10.9 but I do think that the median income decreased in Somerset County where I don't think it decreased in Caroline County. 

#IS THE CHANGE OUTSIDE THE MARGIN OF ERROR
...
**Answer** Accounting for the margin of error, of the top 20 zip codes with the largest amounts, 21201 has a median income of less than $50,000. 
If you are not accounting for the margin of error then these are the zip codes within the top 20 zip codes with the largest amounts with a median income less than $50,000: 21202, 21740, 21201.
```{r}
