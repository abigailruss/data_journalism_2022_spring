...
**Answer** Yes the three files have the same structure. 
...
**Answer** There are 190787 rows in the Maryland PPP data. 
...
**Answer** 190787-- every row in the PPP data has an equivalent in the naics code

#left join eliminates the nonmatches
...
**Answer** The error message says that it can't join two of the columns because they are incompatible types. I think it's because one of the columns are filled with numbers while the other was is for characters. It can't join a character field to a number field. We need to join them in the correct order of the data frames. 
...
**Answer** A lot of the data is missing because the join is only on the zip and ZCTA5N. The PPP data is not all 5 digit zip codes and join is only for an exact match. It can't join what doesn't match so we need to make the PPP data have 5 digits. 
...
**Answer** All of the demographic data is now there because the columns match perfectly. 
...
**Answer** 41968 loans went to ZCTA's with more then 50% non-Hispanic Black populations. The average amounts of the loans were $55,546.84 and the median amount is $19,949. 
...
**Answer** 112056 loans went to ZCTA's with more then 50% non-Hispanic white populations. The average amounts of the loans were $89,194.67 and the median amount is $20,833. 
...
**Answer** In total there are 41,968 PPP loans that went to ZCTAs with more than 50% non-Hispanic Black population, 145 in rural areas and 41,823 in urban populations. The average amount of the rural population was $44,815.22 and the medium amount of the PPP loan was $19,064.57. For the urban PPP loans that went to ZCTAs with more than 50% non-Hispanic Black population the average amount was $55,584.05 and the median amount was $19,950.00.
```{r}
...
**Answer** In total there are 112,056 PPP loans that went to ZCTAs with more than 50% non-Hispanic white population, 18,083 in rural areas and 93,973 in urban populations. The average amount of the rural population was $74,463.32 and the medium amount of the PPP loan was $20,833. For the urban PPP loans that went to ZCTAs with more than 50% non-Hispanic white population the average amount was $92,029.39 and the median amount was $20,833.
