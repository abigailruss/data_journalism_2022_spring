...
**Answer** I see a finder file of with all of the data files and documents. 
...
**Answer** I see a dataframe for hospitals. There are 33 columns including a column for geometry. There are also columns for information about the hospital like the number of beds, if there is a helipad, if there is a trauma center and more. 
...
**Answer** We are filtering out the hospitals and now have a second dataframe for only Maryland hospitals. 
...
What kind of hospitals do we have? General acute care hospital psychiatric, military, chronic disease, long term care, rehabilitation and special. 

### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code sorts all of the different types of hospitals and counts how many hospitals in Maryland fall into that category. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now I am seeing a dataframe for all of the information for Maryland hospitals that are considered general acute care. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We are seeing the hospital data plotted on a grid. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It gives us a dataframe of counties with the geographic elements. 
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** I am getting a dataframe with just Maryland counties. There are 24 rows for the Maryland counties with their geographic information. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** I now have a map of Maryland divided up by county lines. We're saying if it has a geometry column and if so use that column to make a map. It fills in the Chesapeake Bay.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now I have the map of Maryland I had before and I am layering the hospital points onto the map to see what counties they are in.
...
ggplot() + 
  ...
  theme_minimal()
```
What can we tell from this? ----> We can tell which counties the hospitals are in.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now I have more information about the hospitals because I can see how many beds are at each hospital using the scale and where the hospitals are. So now the map tells me more than just where the hospitals are. The background is also no longer gray. 
...
**Answer** The code ran with my API key.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It loads the same dataframe as before. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We have a new dataframe with the total number of beds per county. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now we have a dataframe with the Maryland county population.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We get the dataframe from before but now I have geometry information on the table. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** I am looking at the two dataframes but the names of the counties aren't matched so we're going to have to clean the Maryland county population data. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** I am making it so the names of the Maryland counties are the same so the counties can match/join Maryland beds by county and Maryland county population. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**I now have a new dataframe where I joined Maryland population and the hospital beds.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** I'm cleaning my dataframe so that if there are no beds it says 0 instead of NA beds. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** I am now seeing my dataframe where the number of beds is put into context with Maryland population. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** I now see a map of Maryland divided by county where there is a scale of how many beds there are per 100,000 people and the lighter areas have more beds per 100,000. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** I am seeing the same map as before but now I have changed it so the color scale key is better to make it more easier to read. 
...
**Answer** There are now more specific numbers on the key scale as well as an additional color so there is more variation and the map is more descriptive. it's easier to read the map because there is a greater differential in beds per 100,000 people. I am seeing that in more urban areas there are less beds per 100,000 people while in rural areas, like the panhandle and parts of the eastern shore there are more beds per 100,000 people. 
