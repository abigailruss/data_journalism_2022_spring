...
**Answer** It asks the computer to make sure the tone/sentiments of the word are correct. It assigns words positive and negative sentiment. This dataframe loads 2 dataframes, one for 2020 and one for 2021. Each dataframe has the list of the unique words and the number of times they were used and if the word is positive or negative sentiment. 
