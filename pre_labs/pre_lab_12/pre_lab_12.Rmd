...
**Answer** The following code is taken from the Maryland website because and is a dataframe with all of the vaccines given out by county to keep track of all of the vaccines distributed. It tracks the counties and the type of doses by the dates. 
...
**Answer** There are 284 days that are listed as NA and there is an Unknown county. So what is a county? Is a county the people who got vaccinated in the county or the people who live in the county that got vaccinated anywhere. It's unusual that there are NA with so fewer records and there is an unknown county. It is also interesting that some counties skipped days of vaccinating people. 
...
**Answer** This could be the results for people who traveled to Maryland to get vaccinated. It's the vaccines given out in Maryland that somehow didn't fall into a county.
...
**Answer** Over the last 7 days vaccines are being distributed less and less frequently because fewer people are getting fully vaccinated compared to earlier days. 
...
**Answer** It's showing how we ran out briefly and then we got more and then it tapers off but peaked again around December when we had another wave and needed a third shot. 
...
**Answer** The value of sub is: The number of people in Prince George's County who got fully vaccinated on March 06 decreased by -73.77 percent compared to the week before"
...
**Task** Run the following code and put the value of `sub` in the answer.
**Answer** "The number of people in Prince George's County who got fully vaccinated on March 06 decreased by -73.77 percent compared to the week before" Sub is the subtitles in the labels for the graphic. 
...
**Answer** This chart shows the number of COVID cases over time in each county in Maryland. You can clearly see each wave and when the variants hit. 
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** Now we are using a log scale so it is easier to read all of the lines on the chart that depict the different counties in Maryland and their number of COVID cases over the last few years. 
...
**Answer** There are 24 rows in the mdcounties dataframe. 
...
**Answer** The map is showing the state of Maryland divided by county to show the total number of COVID cases in each county over the last two years as of 4/19. 
