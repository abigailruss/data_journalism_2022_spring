...
```
What is the payroll proceeds percentage for the first result? Put your answer in the space below.
**Answer** 0.00 but the loan about is $1.7 million (1,711,605)
...
**Answer** Characters (dates are characters not numbers)
...
**Answer** Characters is the datatype for data_approved while CleanDate is dttm which is a date and timestamp datatype. 
...
**Answer** April 2020 had 45,042 applications
