...
**Answer** There are 195,865 rows of records. 
...
**Answer** There are problems with title case vs upper case vs lower case. There are also issues with Silver Spring which was a typo. There's also a random name here. 
...
**Answer** We added a city clean column which changed the upper case vs lower case vs title case. For example, it cleaned Pheonix and Westminster. 
...
**Answer** Refiner changed Abell from ABELL and Aberdeen Proving Ground from ABERDEEN PROVING GROUND and it also fixed Aberdeen from ABERDEEN. 
...
**Answer** No the changes are the same from the previous key_collision_merge.
